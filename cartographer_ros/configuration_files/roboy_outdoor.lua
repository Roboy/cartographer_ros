...
POSE_GRAPH.optimization_problem.acceleration_weight = 5e2
...
POSE_GRAPH.constraint_builder.min_score = 0.5 --0.44

-- LOOP CLOSURE --

--  matcher_translation_weight = 5e2,
--  matcher_rotation_weight = 1.6e3,
POSE_GRAPH.matcher_translation_weight = 2e2
--POSE_GRAPH.matcher_rotation_weight = 1.3e5
